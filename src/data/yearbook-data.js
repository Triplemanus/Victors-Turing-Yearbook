const people = {
  ...
  students: [
    ...
    {id: 28, name: 'Harriet', quote: 'Tell me why I don\'t like Mondays', superlative: 'Most likely to Zombify', photo: 'https://placekitten.com/200/300'},
    ...
    {id: 214, name: 'Nina', quote: 'Just once, I\'d like to sit in the front seat', superlative: 'Most likely to catch teh world\'s larget muskellunge', photo: 'https://placekitten.com/200/300'},
    {id: 215, name: 'Ophus', quote: 'Two wrongs don\'t make a right', superlative: 'Most likely to', photo: 'https://placekitten.com/200/300'},
    {id: 216, name: 'Parker', quote: 'But three lefts do!', superlative: 'Most likely to be an Avenger', photo: 'https://placekitten.com/200/300'},
    {id: 217, name: 'Quin', quote: 'Mighty, yes. Mouthy, not so much.', superlative: 'Most likely to lick a postage stamp', photo: 'https://placekitten.com/200/300'},
    {id: 218, name: 'Rosa', quote: 'If it wasn\'t for bad luck...', superlative: 'Most likely to sell state secrets to the Russians', photo: 'https://placekitten.com/200/300'},
    ...
    {id: 220, name: 'Tyrese', quote: 'All for one and one for all!', superlative: 'Most likely to build an Origami Skyscraper', photo: 'https://placekitten.com/200/300'},
    {id: 221, name: 'Ursula', quote: 'Don\'t text me before 10:00am!', superlative: 'Most likely to cheat on DMV test', photo: 'https://placekitten.com/200/300'},
    {id: 222, name: 'Vic', quote: 'Can Catholics eat Incrediburgers on Fridays?', superlative: 'Most likely to pull food out of trash receptacle', photo: 'https://placekitten.com/200/300'},
    {id: 223, name: 'Whitney', quote: 'Vanilla is a flavor!', superlative: 'Most likely to', photo: 'https://placekitten.com/200/300'},
